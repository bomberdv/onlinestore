        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row m0 db img_area">
                    ...
                    <script src="<?php echo base_url('bitcoin-plug/cryptobox.js'); ?>" crossorigin="anonymous"></script>
                    <script> 
                        var test = cryptobox_custom('{u1}', '{u2}', '{u3}', 'gourl_', '{u4}'); 
                    </script>
                    ...
                    <div class="container theme-showcase" role="main">
                        ...
                        <div class="gourl_loader">
                            ...
                            <div class="container text-center gourl_loader_button">
                                <a style="margin:80px 20px 40px 20px" href="" class="btn btn-default btn-lg"><i class='fa fa-spinner fa-spin'></i> &#160; {coin_name} Box Loading ...</a>
                            </div>
                        ...
                        <div class="gourl_cryptobox_unpaid" style="display:none">        
                            ...
                            <div class="row">   
                                <div class="col-md-10">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-heading">
                                            <h3 class="panel-title gourl_addr_title">1. <span class="gourl_texts_coin_address"></span></h3>
                                        </div>
                            ...
                            <div class="row">    
                                <div class="col-md-5">
                                    ...
                                    <div class="panel panel-warning">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">2. <span class="gourl_paymentcaptcha_amount"></span></h3>
                                        </div>
                                        <div class="panel-body">
                                ...
                                <div class="col-md-5">   
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">3. <span class="gourl_paymentcaptcha_status"></span></h3>
                                        </div>
                                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <?php echo form_open('website/Home/submit_checkout#gourlcryptolang');?>
                    ...
                    <form method="post" action="https://payeer.com/merchant/">
                        ...
                        <a href="<?php echo base_url('checkout#step-5'); ?>" class="btn btn-primary  w-md m-b-5"><?php echo display("cancel") ?></a>
                    </form>
                    <?php
                    }
                    ?>
