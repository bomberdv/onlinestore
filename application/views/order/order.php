...
<div class="content-wrapper">
	...
	<section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  	<a href="<?php echo base_url('Corder/new_order')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('new_order')?></a>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'Corder/order_details_data/'.$order['order_id'] ?>"><?php echo $order['order']?>
											</a>
										</td>
										<td>
											<a href="<?php echo base_url().'Ccustomer/customerledger/'.$order['customer_id']; ?>"><?php echo $order['customer_name']?></a>				
										</td>
