...
<table width='570' border='0' cellspacing='0' cellpadding='0'>
	<tbody>
		<tr>
			...
			<td width='10' align='left' style='color:#404041;font-size:12px;line-height:16px;padding:5px 10px 3px 5px;border-bottom:solid 1px #e5e5e5'>
			...
			<td width='15'> 
				...
				<td width='10' align='left' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:5px 5px 3px 5px;border-bottom:dashed 1px #e5e5e5'>
				{sl}
			</td>
	
			<td width='100' align='right' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:5px 5px 3px 5px;border-bottom:dashed 1px #e5e5e5'>
				{product_name} - ({product_model}) {unit}
			</td>
								...
								<td style='color:#404041;font-size:12px;line-height:16px;padding:10px 16px 20px 18px'>
									...
									<table width='0' border='0' align='right' cellpadding='0' cellspacing='0'>
										<tbody>
											...
											<tr>
												<td width='0' align='left' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:15px 0px 3px 0px'>
													<strong><?php echo display('total_cgst') ?>:</strong> 
												</td>
												<td width='100' align='right' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:15px 5px 3px 5px'>
											...
											<tr>
												<td width='0' align='left' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:15px 0px 3px 0px'>
													<strong><?php echo display('total_sgst') ?>:</strong> 
												</td>
												<td width='100' align='right' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:15px 5px 3px 5px'>
											...
											<tr>
												<td width='0' align='left' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:15px 0px 3px 0px'>
													<strong><?php echo display('total_igst') ?>:</strong> 
												</td>
												<td width='100' align='right' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:15px 5px 3px 5px'>
											...
											<tr>
												...
												<td width='100' align='right' valign='top' style='color:#404041;font-size:12px;line-height:16px;padding:5px 5px 3px 5px'>
