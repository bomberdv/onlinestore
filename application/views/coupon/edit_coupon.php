        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Ccoupon/coupon_update/{coupon_id}',array('class' => 'form-vertical', 'id' => 'validate'))?>
                    <div class="panel-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row" id="amount">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="discount_amount" id="discount_amount" type="text" required="" placeholder="<?php echo display('discount_amount')?>" value="{discount_amount}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="percentage">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="discount_percentage" id="discount_percentage" type="text" required="" placeholder="<?php echo display('discount_percentage')?>" value="{discount_percentage}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control coupon_date " name ="start_date" id="start_date" type="text" required="" placeholder="<?php echo display('start_date')?>" value="{start_date}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control coupon_date " name ="end_date" id="end_date" type="text" required="" placeholder="<?php echo display('end_date')?>" value="{end_date}">
                            </div>
                        </div>
