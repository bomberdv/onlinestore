        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Ccoupon/manage_coupon')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_coupon')?></a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Ccoupon/insert_coupon', array('class' => 'form-vertical','id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row" id="amount">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="discount_amount" id="discount_amount" type="text" required="" placeholder="<?php echo display('discount_amount')?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="percentage">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="discount_percentage" id="discount_percentage" type="text" required="" placeholder="<?php echo display('discount_percentage')?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control coupon_date " name ="start_date" id="start_date" type="text" required="" placeholder="<?php echo display('start_date')?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control coupon_date " name ="end_date" id="end_date" type="text" required="" placeholder="<?php echo display('end_date')?>">
                            </div>
                        </div>
