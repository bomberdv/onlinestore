                    ...
                    <div class="panel-heading">
                 	...
                 	<div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="last_day_closing" class="form-control" value="{last_day_closing}"/>
                            </div>
                        </div>
                       	...
                       	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="cash_in" value="{cash_in}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="cash_out" value="{cash_out}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="amount" name="cash_in_hand" value="{cash_in_hand}"/>
                            </div>
                        </div>
