...
<tfoot>
    ...
    <tr>
        ...
        <td class="text-right">
            <input type="text" id="invoice_discount" class="form-control text-right" name="invoice_discount" value="<?php if($invoice_discount){ echo $invoice_discount - $total_discount;}?>" onkeyup="calculateSum();" onchange="calculateSum();" placeholder="0.00"/>
        </td>
    </tr>
    <tr>
        <td style="text-align:right;" colspan="2"><b><?php echo display('service_charge') ?>:</b></td>
        <td class="text-right">
            <input type="text" id="service_charge" class="form-control text-right" name="service_charge" value="<?php echo $service_charge?>" placeholder="0.00" onkeyup="calculateSum();" onchange="calculateSum();"/>
        </td>
    </tr>
