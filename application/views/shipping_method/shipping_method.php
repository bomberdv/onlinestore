        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cshipping_method')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_shipping_method')?></a>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								?>
									<tr>
										...
										<td class="text-center"><?php echo $value['method_name']?></td>
										<td class="text-center"><?php echo $value['details']?>
										<td class="text-center"><?php echo $value['charge_amount']?></td>
										<td class="text-center"><?php echo $value['position']?></td>
										<td>
											<center>

												<a href="<?php echo base_url().'Cshipping_method/shipping_method_update_form/'.$value['method_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>

												<a href="<?php echo base_url('Cshipping_method/shipping_method_delete/'.$value['method_id'])?>" class="btn btn-danger btn-sm" onclick="return confirm('<?php echo display('are_you_sure_want_to_delete')?>');" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
											</center>
										</td>
									</tr>
								<?php
