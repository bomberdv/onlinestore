									...
									<?php } ?>
										<td style="border: 1px solid black ;padding: 5px">		
											...
											<div class="barcode-inner" style="font-family: 'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif;text-align: center; position: relative;">
												...
												<img src="<?php echo base_url('Cbarcode/barcode_generator/{product_id}')?>" class="img-responsive center-block" alt="" style="display: block;margin-left: auto;margin-right: auto;height: 42px;width: 140px;">
												...
												<div class="price" style="font-weight: 500;line-height: 10px;margin-top: 5px;"><?php echo (($position==0)?"$currency {price}":"{price} $currency")?> 
													<small style="font-weight: 600;font-size: 9px;"><?php echo display('excl_vat')?></small>
												</div>
											</div>
								...
								<?php } ?>
									<td style="border: 1px solid black ;padding: 5px">	
										<div class="barcode-inner" style="font-family: 'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif;text-align: center; position: relative;">
											...
											<div class="product-name-details" style="font-size: 11px;letter-spacing: 0.5px;font-weight: 600;text-transform: uppercase;line-height: 8px;">{product_name}</div>
											<div class="price" style="font-weight: 500;line-height: 10px;margin-top: 5px;"><?php echo (($position==0)?"$currency {price}":"{price} $currency")?> <small style="font-weight: 600;font-size: 9px;"><?php echo display('excl_vat')?></small>
											</div>
										</div>
									</td>
									<?php if($counter == 5) { ?>
