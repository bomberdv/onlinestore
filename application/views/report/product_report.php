		...
		<div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <!-- <a href="<?php echo base_url('Admin_dashboard/total_profit_report')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i><?php echo display('profit_report')?></a> -->
                </div>
            </div>
        </div>
