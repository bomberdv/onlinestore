                   ...
                   <?php echo form_open_multipart('Csettings/update_bank/'.$bank_list[0]['bank_id'],array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="ac_name" id="account_name" required="" placeholder="<?php echo display('account_name') ?>" value="<?php echo $bank_list[0]['ac_name']?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="ac_number" id="account_no" required="" placeholder="<?php echo display('account_no') ?>" value="<?php echo $bank_list[0]['ac_number']?>"/>
                            </div>
                        </div>
