...
<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cquotation/quotation_update',array('class' => 'form-vertical','id'=>'normalinvoice' ))?>
	...
	<tbody id="addinvoiceItem">
		...
		<tr>
			<td class="span3">
				<input type="text" name="product_name" onclick="invoice_productList(<?php echo $i?>);" value="<?php echo $value['product_name']?>-<?php echo $value['product_model']?>" class="form-control productSelection" required placeholder='<?php echo display('product_name') ?>' >
			...
			<td>
				...
				<input type="hidden" name="quotation_details_id[]" id="quotation_details_id" value="<?php echo $value['quotation_details_id']?>"/>
			</td>
            <td>
	...
	<tfoot>
        ...
        <tr>
            <td style="text-align:right;" colspan="2"><b><?php echo display('quotation_discount') ?>:</b></td>
            <td class="text-right">
                <input type="text" id="invoice_discount" class="form-control text-right" name="invoice_discount" value="<?php if($quotation_discount){ echo $quotation_discount - $total_discount;}?>" onkeyup="calculateSum();" onchange="calculateSum();"/>
            </td>
        </tr>
        <tr>
            <td style="text-align:right;" colspan="2"><b><?php echo display('service_charge') ?>:</b></td>
            <td class="text-right">
                <input type="text" id="service_charge" class="form-control text-right" name="service_charge" value="<?php echo $service_charge?>" onkeyup="quantity_calculate();" onchange="quantity_calculate();"/>
            </td>
        </tr>
        ...
        <tr>
            <td align="center">
                <input type="button" id="add-invoice-item" class="btn btn-info valid" name="add-invoice-item" onclick="addInputField('addinvoiceItem');" value="Add New Item" aria-invalid="false">
